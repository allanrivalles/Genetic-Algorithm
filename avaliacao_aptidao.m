function [rank_ind,n_calc_erro] = avaliacao_aptidao(img,n_ind,cod_img,n_eletr,pot_borda_obj_estudo,n_calc_erro)
...
for j = 1:n_ind
    ...
    img_dpe.elem_data = img(j).elem_data;
